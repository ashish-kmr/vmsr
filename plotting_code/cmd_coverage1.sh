...
basestr="n0100_inits05_or01_unroll408_rinit1"
...
CUDA_VISIBLE_DEVICES=1 PYOPENGL_PLATFORM=egl PYTHONPATH=. python plotting_code/stitched.py \
  ...
  --run_name "$basestr".0000068000_009_009 \
  --color 'b-' \
  --label 'VMSR (Ours)'&  
...
#  --test_type area4\
#  --expt_name 10_6,12,18_77000__32_4_-1_9,12,15,18_30,-20_80,-40_RN5N__40.4,10,16_10,15,20_30_8_30,-10_60,-30_F_1500\
#  --run_name "$basestr".0000068000_009_009_random \
#  --color 'b-' \
#  --label 'Ours Random'&  
#
bsmethod=stat
CUDA_VISIBLE_DEVICES=1 PYOPENGL_PLATFORM=egl PYTHONPATH=. python plotting_code/stitched.py \
  ...
  --test_type area4 \
  --expt_name $bsmethod\
  --run_name "$basestr"."$bsmethod"_0.660 \
  --color 'k-'\
...
CUDA_VISIBLE_DEVICES=1 PYOPENGL_PLATFORM=egl PYTHONPATH=. python plotting_code/stitched.py \
  ...
  --test_type area4\
  --expt_name $bsmethod\
  --run_name "$basestr".0001024320_000_999 \
  --color 'g-'\
...
CUDA_VISIBLE_DEVICES=1 PYOPENGL_PLATFORM=egl PYTHONPATH=. python plotting_code/stitched.py \
  ...
  --test_type area4\
  --expt_name $bsmethod\
  --run_name "$basestr".0001024080_009_009 \
  --color 'm-'\
